package com.programmer.jgallos.blogzone;
...
/*
         if (isNetworkAvailable(getApplicationContext())) {
            ...
            Toast.makeText(getApplicationContext(), "You are not connected to the internet. Please connect first.", Toast.LENGTH_LONG).show();
